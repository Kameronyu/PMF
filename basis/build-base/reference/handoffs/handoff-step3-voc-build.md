---
status: reference
role: External VOC build handoff (PMF research Step-3 / VOC = pipeline STEP 4 pass-1 + STEP 6 pass-2/3). Self-contained build brief for the net-new VOC engine.
read-with:
  - briefs/STEP-04-voc-market-pass.md
  - briefs/STEP-06-voc-deep-pass.md
supersedes: []
note: Brought in from the operator on 2026-06-24; references its own external canon (definitions.md, workflow.md, capability_inventory.md, Vindicta prompts) not held in this base.
---

> **What this is:** the complete build context for the net-new VOC engine. **Read by:** the VOC build sessions (the STEP-04 and STEP-06 briefs point here).
