# Tuning automate's trigger description (run in your authenticated Claude Code)
...
From the skill-creator directory:
    ...
    python -m scripts.run_loop \
      --eval-set <path-to>/automate/evals/trigger_eval.json \
      --skill-path <path-to>/automate \
...
held-out test score. Paste `best_description` into automate/SKILL.md frontmatter.
